...
class ApikeyApi extends runtime.BaseAPI {
    ...
    v1SessionsGetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.InternalServerPublicSessionListFromJSON)(jsonValue));
        });
    }
    /**
     * Lists browser sessions with pagination
    ...
    v1SessionsIdExtendPostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.InternalServerPublicExtendSessionRequestToJSON)(requestParameters['internalServerPublicExtendSessionRequest']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.InternalServerPublicSessionFromJSON)(jsonValue));
        });
    }
    /**
     * Extends the duration of an active browser session
    ...
    v1SessionsPostRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.InternalServerPublicCreateSessionRequestToJSON)(requestParameters['internalServerPublicCreateSessionRequest']),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.InternalServerPublicSessionFromJSON)(jsonValue));
        });
    }
